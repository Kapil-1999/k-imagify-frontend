            ...
            <div> {
                user ?
                    <div className='flex items-center gap-2 sm:gap-3 '>
                        <button onClick={() => navigate("/buy")} className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-all'>
                            <img src={assets.credit_star} alt="" className='w-5' />
                            <p className=' text-gray-600 max-sm:hidden pl-4'>Credit Left : 50</p>
                        </button>
                        <p className='text-xs sm:text-sm font-medium text-gray-600'>Hi, Kapil</p>
